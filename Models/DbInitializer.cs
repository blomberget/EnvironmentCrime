using System;
using System.Linq;
using Microsoft.Extensions.DependencyInjection;//Datat som ska läggas in i databasen. namespace Crime.Models
{
    ...
    public static void EnsurePopulated(IServiceProvider services)
    {      var context = services.GetRequiredService<ApplicationDbContext>();
      ...
      if (!context.Employees.Any())
      {
        context.Employees.AddRange(
          new Employee { EmployeeId = "E001", EmployeeName = "Östen Örling", RoleTitle = "Coordinator", DepartmentId = "D00" },
      ...
      if (!context.Errands.Any())
      {
        context.Errands.AddRange(
          new Errand {
            ...
            Place = "Skogslunden vid Jensens gård", TypeOfCrime = "Sopor",
